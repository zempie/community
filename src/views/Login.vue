  ...
  <div class="landing">
    ...
    <div class="landing-info">
      ...
      <div class="tab-switch">
        <p ref="loginBtn" class="tab-switch-button login-register-form-trigger">
          Login
        </p>
    ...
    <div class="landing-form">
              ...
              <div class="form-input">
                ...
                >
                  <b-form-input
                    ...
                    :state="onSubmit ? validateState('email') : undefined"
                  ></b-form-input>
              ...
              <div class="form-input">
                <b-form-group label="Password" label-for="login-password">
                  <b-form-input
                    ...
                    :state="onSubmit ? validateState('password') : undefined"
                  ></b-form-input>

                  <b-form-invalid-feedback
                    >영문과 최소 1개의 숫자 혹은 특수 문자를 포함한 6~20자리
      ...
      <div class="form-box login-register-form-element" style="top: 27%">
        ...
        <form class="form">
          ...
          <div class="form-row">
            <div class="form-item">
              <button class="button medium primary" @click="googleRegisterDone">
                Register Now!
              </button>
            </div>
          </div>
