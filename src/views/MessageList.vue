                    ...
                    <div class="simplebar-content" style="padding: 0px">
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-text">
                            Great! Then we'll meet with them at the party...
                          </p>
                      ...
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-title">
                            <span class="bold">Matt Parker</span>
                          </p>
                      ...
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-title">
                            <span class="bold">Sandra Strange</span>
                          </p>
                      ...
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-title">
                            <span class="bold">Destroy Dex</span>
                          </p>
                      ...
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-title">
                            <span class="bold">Damian Greyson</span>
                          </p>
                      ...
                      <div class="chat-widget-message">
                        <div class="user-status">
                          ...
                          <p class="user-status-title">
                            <span class="bold">Paul Lang</span>
                          </p>
          ...
          <div class="chat-widget-header">
            <div class="chat-widget-settings">
              <div class="post-settings-wrap" style="position: relative">
                ...
                <div
                  class="simple-dropdown widget-box-post-settings-dropdown"
                  style="
                    position: absolute;
                    z-index: 9999;
                    top: 30px;
                  ...
                  >
                    <div class="simplebar-content" style="padding: 35px 28px">
                      ...
                      <div class="chat-widget-speaker right">
                        ...
                        <p class="chat-widget-speaker-message">
                          You're right, it's been a really long time! I think
                          the last time we saw was at Neko's party
                        </p>
