        ...
        <div class="widget-box-settings">
          <div class="post-settings-wrap">
            ...
            <div class="simple-dropdown widget-box-post-settings-dropdown">
              ...
              <p class="simple-dropdown-link" @click="reportPost">
                포스팅 신고
              </p>
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="content-actions">
              <div class="content-action">
                <div class="meta-line">
                  <div class="meta-line-list reaction-item-list">
                    <div class="reaction-item reaction-item-dropdown-trigger">
                      <img
              ...
              <div class="content-action">
                <div class="meta-line">
                  <p class="meta-line-link">{{ feed.comment_cnt }} Comments</p>
                </div>

                <div class="meta-line">
                  <p class="meta-line-text">{{ feed.shared_cnt }} Shares</p>
                </div>
              </div>
            </div>
          </div>
...
export default class Feed extends Vue {
  ...
  deletePost(feedId: number) {
    const result = this.$api.deletePost(feedId);
  }
  reportPost() {
