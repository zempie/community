  ...
  <div>
    <div class="grid mobile-prefer-content">
      <div
        ...
        "
      >
        <post-dropdown :feedId="feed.id" @postEdit="postEdit"></post-dropdown>
          ...
          <div class="widget-box-status-content">
            <div class="user-status">
              ...
              <p class="user-status-title medium">
                ...
                uploaded a
                <span class="bold">{{ feed.post_type }} post</span>
              </p>
            ...
            <div class="content-actions">
              <div class="meta-line">
                <div class="meta-line-list reaction-item-list">
                  <div
                    class="reaction-item reaction-item-dropdown-trigger"
                    style="width: 100%"
                  >
                    <img
                    ...
                    <p class="bold" style="margin-left: 5px; font-size: 12px">
                      {{ feed.like_cnt }} Likes
                    </p>
                  </div>
                </div>
...
import EditPost from "@/components/timeline/post/EditPost.vue";
