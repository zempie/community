<template>
  ...
  <div class="quick-post" id="postContainer">
        ...
        <div class="form-row">
          <div class="form-item">
            <div class="form-textarea">
              ...
              <image-preview :key="isResetEditor"></image-preview>
    ...
    <div class="quick-post-footer post-select category-select">
      <!-- todo: user id send -->
      <custom-tooltip
        @channel="getChannel"
      ...
      <div
        ...
        :key="category.idx"
      >
        <button class="selected-category">
...
export default class Post extends Vue {
  ...
  getChannel(channel) {
    console.log(channel, this.selectedCommunity);
    this.selectedCategory.push({
      channel: channel,
      community: this.selectedCommunity,
    });

    console.log("chaneel", this.selectedCategory);
  }
