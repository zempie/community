    ...
    <div class="quick-post" id="postContainer">
        ...
        <div class="quick-post-footer attachment">
            ...
            <div class="quick-post-footer-actions">
                ...
                <slot name="saveType">
                    <p class="button small secondary" @click="uploadPost">
                        Post
                    </p></slot
                >
            </div>
    ...
    async mounted() {
        ...
        if (this.feed) {
            ...
            if (this.feed.attatchment_files.img) {
                fileLoader.fileObj.img = this.feed.attatchment_files.img;
            } else if (this.feed.attatchment_files.audio) {
                fileLoader.fileObj.audio = this.feed.attatchment_files.audio;
            } else if (this.feed.attatchment_files.video) {
                fileLoader.fileObj.video = this.feed.attatchment_files.video;
            }

            console.log("fileLoader", fileLoader.fileObj);
