<template>
    <article class="post-open">
        <figure
            class="post-open-cover liquid"
            style="
                background: url('img/cover/19.jpg') center center / cover
                    no-repeat;
            "
        >
        ...
        <div class="post-open-body">
            ...
            <div class="post-options">
                <div class="post-option-wrap" style="position: relative">
                    ...
                    <div
                        class="reaction-options reaction-options-dropdown"
                        style="
                            position: absolute;
                            z-index: 9999;
                            bottom: 54px;
                ...
                <div class="post-comment">
                    ...
                    <p class="post-comment-text">
                        <a
                            ...
                            href="profile-timeline.html"
                            >Bearded Wonder</a
                        >It's really inspiring to read about this and how you
                        managed to get all up and running! Super awesome!
                        Congratz
                            ...
                            <div class="meta-line" style="position: relative">
                                ...
                                <div
                                    class="
                                        reaction-options
                                        small
                                        reaction-options-small-dropdown
                                    "
                                    style="
                                        position: absolute;
                                        z-index: 9999;
                            ...
                            <div class="meta-line settings">
                                ...
                                >
                                    <div
                                        class="
                                            post-settings
                                            post-settings-dropdown-trigger
                                        "
                                    >
                                        <svg
                                            class="
