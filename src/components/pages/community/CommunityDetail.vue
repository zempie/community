    ...
    <div class="profile-header v2">
      ...
      <div class="profile-header-info">
        <div class="user-short-description big">
          <a
            class="user-short-description-avatar user-avatar big no-stats"
          ...
          <p class="user-short-description-title">
            <a href="group-timeline.html">{{ community.name }}</a>
          </p>

          <p class="user-short-description-text">{{community.description}}</p>
        </div>
    ...
    <nav class="section-navigation">
      <div id="section-navigation-medium-slider" class="section-menu secondary">
        ...
        <router-link
          ...
          to="/community/communityDetail/members"
        >
