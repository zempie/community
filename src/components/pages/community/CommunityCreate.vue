      ...
      <div class="widget-box-content">
        <form class="form">
              ...
              <div class="form-input small">
                <b-form-group label="Group Name" label-for="group-name">
                  <b-form-input
                    ...
                    :state="
                      createCommunity ? validateState('groupName') : undefined
                    "
                  ></b-form-input>
          ...
          <div class="form-row">
            <div class="form-item">
              <div class="form-input small">
                <b-form-group label="Group URL" label-for="group-url">
                  <b-form-input
                    class="form-control"
                    type="text"
                    id="group-url"
                    ...
                    :state="
                      createCommunity ? validateState('groupUrl') : undefined
                    "
                  ></b-form-input>
                  <b-form-invalid-feedback
                    >필수 입력사항입니다. 50자 이내로
              ...
              <div class="form-input small mid-textarea">
                <b-form-group label="Description" label-for="description">
                  <b-form-textarea
                    ...
                    :state="
                      createCommunity ? validateState('description') : undefined
                    "
                  ></b-form-textarea>
